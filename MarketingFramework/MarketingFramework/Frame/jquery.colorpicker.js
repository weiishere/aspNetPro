    ...
    $.fn.colorpicker = function(options) {
        ...
        return this.each(function(){
            ...
            obj.bind(opts.event,function(){
                ...
                var target = _tar = opts.target ? $(opts.target) : obj;
        ...
        function initColor(){
            $("body").append('<div id="colorpanel" style="position: absolute; display: none;box-shadow:1px 1px 8px #666"></div>');
            var colorTable = '';
            var colorValue = '';
            for(i=0;i<2;i++){
                for(j=0;j<6;j++){
            ...
            colorTable='<table width=253 border="0" cellspacing="0" cellpadding="0" style="border:1px solid #666;">'
            ...
            +'<td width="3"><td><input type="text" id="HexColor" size="7" style="border:inset 1px;font-family:Arial;" value="#000000"><a href="javascript:void(0);" id="_cclose">透明</a> | <a href="javascript:void(0);" id="_creset">清除</a></td></tr></table></td></table>'
            ...
            $("#_cclose").live('click', function () {
                _tar.val("transparent").css("color", "#ffffff");
                $("#HexColor").val("transparent");
                $("#DisColor").css("background", "transparent");
                $("#colorpanel").hide(70);
                return false;
            }).css({
                "font-size":"12px",
