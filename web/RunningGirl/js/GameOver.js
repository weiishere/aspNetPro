...
GameOver.prototype.init = function(){
	...
	self.getRank();
	//var str = '[{"index":0,"name":"test2","value01":"49","value02":"0","value03":"0"},{"index":1,"name":"test","value01":"19","value02":"0","value03":"0"},{"index":2,"name":"test","value01":"19","value02":"0","value03":"0"},{"index":3,"name":"test","value01":"19","value02":"0","value03":"0"},{"index":4,"name":"test","value01":"19","value02":"0","value03":"0"}] ';
	//self.rankShow(str);
};
GameOver.prototype.updateDistance = function(event){
	...
	if(LString.trim(self.inputOne.text+"").length == 0){
		alert("名前を入力してください。");
		return;
	}
	self.nameLabel.visible = false;
	self.inputOne.visible = false;
	self.ex.visible = true;
	LAjax.post("/game/set_global_ranking/",
		{
			game_name:"RunningGirl",
			name:self.inputOne.text,
			stage:0,
			value01:runCharacter.distanceObj.value,
			com01:">"
		},
		function(data){
			self.nameLabel.visible = true;
			self.inputOne.visible = true;
			self.ex.visible = false;
			self.inputOne.text = "";
			self.getRank();
		}
...
GameOver.prototype.getRank = function(){
	...
	LAjax.post("/game/get_global_ranking/",
		{game_name:"RunningGirl",stage:0,"sort":"value01-desc","limit":5},function(data){
			self.rankShow(data);
		}
	);
};
