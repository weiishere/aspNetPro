...
(function (exp) {
    ...
    function onframe() {
        ...
        if (isSoundLoaded) { if (!sound.playing) sound.play(); }
    }
    //初始化抛算月饼算法
    ...
    var totalGameData = function (scorePanel) {
        ...
        var totalCount = new Number(getCakeCount, "2"); totalCount.x = scorePanel.getWidth() - 180; totalCount.y = LGlobal.height - 340;
        ...
        var wxData = {
            "appId": "", // 服务号可以填写appId
            "imgUrl": 'http://teamotto.net/ICON.png',
            "link": "http://www.teamotto.net/crazycake.html",
    ...
    loadImages("load.gif", function (img) {
